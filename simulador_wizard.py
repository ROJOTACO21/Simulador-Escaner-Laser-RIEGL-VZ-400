...
phi_start = st.number_input("Start angle (°)", min_value=0.0, max_value=360.0, value=0.0, step=1.0)
phi_stop = st.number_input("Stop angle (°)", min_value=0.0, max_value=360.0, value=180.0, step=1.0)
...
theta_start = st.number_input("Start angle (°)", min_value=30.0, max_value=130.0, value=30.0, step=1.0)
theta_stop = st.number_input("Stop angle (°)", min_value=30.0, max_value=130.0, value=100.0, step=1.0)
